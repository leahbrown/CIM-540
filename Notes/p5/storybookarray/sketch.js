var page0,pag1,page2,page3;

var image0,image1,image2,image3;

var currentImage =0;

var story = ["There was a dinosaur","And he liked to dance","And a meteor was coming","And it passed","click the buttons below to read the story"];

var imageArray = [];
//:decalaring it empty because of the load image function becasue when you call preload
//:javascript can live outside of p5js
//:load image is specific to p5
function preload(){
